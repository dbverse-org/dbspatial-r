# Determine if geometries in two [`dbSpatial`](https://dbverse-org.github.io/dbspatial-r/reference/dbSpatial.md) objects cross each other
...
- name:
  ...
  `character`. Default: "crosses_geom"
...
res <- st_crosses(x = points,
                  y = points2,
                  overwrite = TRUE)
#> Error in st_crosses(x = points, y = points2, overwrite = TRUE): could not find function "st_crosses"
