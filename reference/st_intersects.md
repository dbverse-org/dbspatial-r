# Determine if geometries between two [`dbSpatial`](https://dbverse-org.github.io/dbspatial-r/reference/dbSpatial.md) objects are intersecting
...
- name:
  ...
  `character`. Default: "intersect_geom"
...
res <- st_intersects(x = points,
                     y = points2,
                     overwrite = TRUE)
#> Error in st_intersects(x = points, y = points2, overwrite = TRUE): could not find function "st_intersects"
