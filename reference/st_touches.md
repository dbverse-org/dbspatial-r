# Determine if geometries in two [`dbSpatial`](https://dbverse-org.github.io/dbspatial-r/reference/dbSpatial.md) objects touch each other
...
- name:
  ...
  `character`. Default: "touches_geom"
...
res <- st_touches(x = points,
                  y = points2,
                  overwrite = TRUE)
#> Error in st_touches(x = points, y = points2, overwrite = TRUE): could not find function "st_touches"
