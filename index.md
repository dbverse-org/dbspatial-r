...
[dbSpatial](https://github.com/dbverse-org/dbspatial-r) is a core
package in the [`dbverse`](https://dbverse-org.github.io/dbverse/)
library.

The goal of [dbSpatial](https://github.com/dbverse-org/dbspatial-r) is
to provide larger-than-memory spatial operations for various spatial
data sources. The package largely relies on the [DuckDB spatial
...
page](https://github.com/dbverse-org/dbspatial-r/).**
