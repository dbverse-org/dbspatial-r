# Determine if geometries in two [`dbSpatial`](https://dbverse-org.github.io/dbspatial-r/reference/dbSpatial.md) objects are disjoint
...
- name:
  ...
  `character`. Default: "disjoint_geom"
...
res <- st_disjoint(x = points,
                   y = points2,
                   overwrite = TRUE)
#> Error in st_disjoint(x = points, y = points2, overwrite = TRUE): could not find function "st_disjoint"
