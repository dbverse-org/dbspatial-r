# Determine if geometries in two [`dbSpatial`](https://dbverse-org.github.io/dbspatial-r/reference/dbSpatial.md) objects are covered by each other
...
res <- st_covered_by(x = points,
                     y = points2,
                     overwrite = TRUE)
#> Error in st_covered_by(x = points, y = points2, overwrite = TRUE): could not find function "st_covered_by"
