...
`{dbSpatial}` is a core package in the [`dbverse`](https://dbverse-org.github.io/dbverse/) library.
...
**Note: Work in progress! Bugs or unexpected behavior are likely to occur. We welcome user feedback and reporting issues on the [Github page ](https://github.com/dbverse-org/dbSpatial/).**
