# Determine if geometries in two [`dbSpatial`](https://dbverse-org.github.io/dbspatial-r/reference/dbSpatial.md) objects are equal
...
res <- st_equals(x = points,
                 y = points2,
                 overwrite = TRUE)
#> Error in st_equals(x = points, y = points2, overwrite = TRUE): could not find function "st_equals"
